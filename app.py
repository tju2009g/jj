...
# 입시제도 키워드는 (1) 서울·수도권 소재 대학 관련 뉴스, (2) 2028학년도 대입 제도 변경 뉴스로 한정.
# "입시제도" 카테고리는 화면에서 항상 "트렌드" 카테고리보다 위에 오도록 우선 배치됨
NEWS_KEYWORDS = [
    {"query": "서울 소재 대학 입시", "category": "입시제도"},
    {"query": "수도권 대학 입시", "category": "입시제도"},
    {"query": "2028 대입 제도 개편", "category": "입시제도"},
    {"query": "2028학년도 대학입시", "category": "입시제도"},
...
word_preview = get_words_of_day()[0]
idiom = get_idiom_of_day()
fact = get_science_fact_of_day()
