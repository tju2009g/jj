    ...
    for w in get_words_of_day():
        st.markdown(
            ...
            <div class="card">
                <details>
                    <summary>
                        <span class="word-en">{w['word']}</span> <span class="word-badge">{w['category']}</span>
                    </summary>
                    <div style="margin-top:0.5rem;">
                        <span style="color:#374151;">{w['meaning']}</span>
                        <div style="margin-top:0.5rem; padding:0.6rem 0.8rem; background:#f9fafb; border-left:3px solid #4338ca; border-radius:6px;">
                            <span style="color:#1f2937;">{w['example_en']}</span><br>
                            <span style="color:#6b7280; font-size:0.85rem;">{w['example_ko']}</span>
                        </div>
                    </div>
                </details>
            </div>
